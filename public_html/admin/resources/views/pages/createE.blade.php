  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row d-flex justify-content-center">
        <div class="col-md-8">
          <form method="post" action="{{ route('service-update') }}" autocomplete="off" class="form-horizontal" id="prof">
            @csrf
            @method('POST')
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                ...
                <p class="card-category">Čia galite redaguoti paslaugą</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input class="form-control" name="id" id="id" type="text" value="{{ $service->id }}" hidden />
                        <input class="form-control" name="name" id="name" type="text" value="{{ $service->name }}" required/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                        <input class="form-control" name="cmd" id="cmd" type="text" value="{{ $service->cmd }}" required/>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                    	<input class="form-control" name="cost" id="cost" type="text" value="{{ $service->cost }}" required/>
                    </div>
                  </div>
                </div>
